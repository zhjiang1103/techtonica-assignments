...
// num2 but not num1?
//Number 1 and 10 would be valid for num2 but not num 1 beacause num2 has the "equal to" range, which means num2 includes 1 and 10.
...
let statement=`History, my name is ${myName}, and I can't wait to visit ${dreamDestinatin}!`
