...
function exercise1(num1) {
  ...
  function exercise3(num3) {
    ...
    // Write your code for the exercise below here:
    // --------------------------------------------
    if (num3 > 0) {answer3=`${num3} is positive`}
    else if (num3 <0) {answer3=`${num3} is negative`}
  ...
  function exercise4(varA, varB) {
    ...
    // Write your code for the exercise below here:
    // --------------------------------------------
    if (varA == varB){answer4="varA and varB are equal"}
  ...
  // If varA and varB are array, then it is possible that they are the same array but in diffrent order. EX: console.log([2,4]==[4,2]), Javascript will return false
  ...
  function exercise6(varA, varB, varC) {
    ...
    // Write your code for the exercise below here:
    // --------------------------------------------
    if(varA==varB && (varA != varC || varB != varC)){answer6=true}
    else {answer6=false};
    // --------------------------------------------
    // And above here
    // --------------------------------------------
  ...
  // "Buz" zto `answer10` if the value of `num10` is divisible by 5
